...
public class NOWPaymentClient {
    ...
    public AuthService authenticate(){
        return new AuthService(transport, json);
    }
    public PayoutService payouts(){
        return new PayoutService(transport, auth, json);
    }
}
